...
<header class="oxford-blue-header header">
    <div class="px-3 py-2 text border-bottom">
      <div class="container">
  ...
  <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293z"/>
            ...
            <a href="#" class="nav-link text-white d-flex flex-column align-items-center">
              ...
              <a href="#" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24" aria-hidden="true"><use xlink:href="#speedometer2"></use></svg>
                Dashboard
              </a>
            </li>
            </li>
            ...
            <li>
              <a href="#" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24" aria-hidden="true"><use xlink:href="#people-circle"></use></svg>
                Customers
              </a>
            </li>
          </ul>
          ...
          <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../icons/disco_ball_pic.png" alt="profile_pic" width="50" height="50" class="rounded-circle">
          </a>
