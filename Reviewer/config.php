...
define('SEND_FROM', "AdmissionSystem@Oxford.com");
 
// Define the name of the website from which the email is sent. 
define('SEND_FROM_NAME', "Oxford University Admissions");
 
// Define the reply-to address.
define('REPLY_TO', "AdmissionSystem@Oxford.com");
 
// Define the reply-to name.
define('REPLY_TO_NAME', "Jennifer"); 
